...
def get_ai_suggestion(locator, html_source):
    prompt = (
        ...
        f"{html_source}\n\n"
        f"Using the provided HTML, suggest a simple, reliable, and valid XPath for identifying the element based on its `class` attribute. "
        f"Ensure the XPath is in the format: `tagname[contains(@class, 'class_name')]` or a valid equivalent. "
